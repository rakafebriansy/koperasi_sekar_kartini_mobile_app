...
abstract class ApiClient {
  ...
  Future<dynamic> updateReport({
    ...
    @Field('deposit_compliance_percentage') double? depositCompliancePercentage,
    @Field('attendance_percentage') double? attendancePercentage,
    @Field('organization_final_score_percentage')
    ...
    @Field('cash_participation_percentage') double? cashParticipationPercentage,
    @Field('savings_participation') int? savingsParticipation,
    @Field('savings_participation_percentage')
    double? savingsParticipationPercentage,
    @Field('meeting_deposit_percentage') double? meetingDepositPercentage,
