...
void main() {
  ...
  group('EmployeeManageReportController', () {
    ...
    test(
      'createReport calls apiHelper.fetch and returns ReportModel',
      () async {
        when(
          () => mockApi.fetch<ReportModel>(request: any(named: 'request')),
    ...
    test(
      'updateReport calls apiHelper.fetch and returns ReportModel',
      () async {
        when(
          () => mockApi.fetch<ReportModel>(request: any(named: 'request')),
        ).thenAnswer((_) async => reportModel);
