...
import 'package:koperasi_sekar_kartini_mobile_app/app/modules/user_savings_list/controllers/user_savings_list_controller.dart';
...
void main() {
  ...
  late UserSavingsListController controller;
  ...
  setUp(() {
    ...
    controller = UserSavingsListController(apiHelper: mockApi);
  ...
  group('UserSavingsListController', () {
